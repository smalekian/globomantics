    ...
    <footer>
      <div className="container">
        <div className="main-footer col-md-12 col-xs-12">
          <div className="foter-logo col-md-3 col-sm-3 col-xs-2">
            <a href="index.html">
              <img className="desktop" src="images/Globo-Logo-white-footer.svg" alt="" />
      ...
      <div className="video-sec col-md-4 col-sm-12 col-xs-12">
        <p className="footer-p">
          This site is created for demonstrative purposes only and does not offer any real products
          or services.
        </p>
      </div>
    </footer>
